...
* **mk-session:** Issue 番号から worktree とセッションを一括セットアップするプラグインを追加 ([#54](https://github.com/yukimasaki/claude-plugins/issues/54)) ([ea62407](https://github.com/yukimasaki/claude-plugins/commit/ea62407d8519684c503f4244c283c77facb5f292))

## [0.4.7](https://github.com/yukimasaki/claude-plugins/compare/v0.4.6...v0.4.7) (2026-05-10)


### Features

* **design-director:** 3 デザイナー + ユーザー参加の 4 者ディベート prompt-pack を追加 ([#47](https://github.com/yukimasaki/claude-plugins/issues/47)) ([3387860](https://github.com/yukimasaki/claude-plugins/commit/3387860779ca22730e6d78c00380eb069584bf91))

## [0.4.6](https://github.com/yukimasaki/claude-plugins/compare/v0.4.5...v0.4.6) (2026-05-07)


### Features

* **design-director:** ディベート系 prompt-pack の結果に操作フロー説明と ASCII モックを必須化 ([#44](https://github.com/yukimasaki/claude-plugins/issues/44)) ([89f6322](https://github.com/yukimasaki/claude-plugins/commit/89f6322662137a78d9eb1e618ff20c767b008736)), closes [#43](https://github.com/yukimasaki/claude-plugins/issues/43)
...
* **design-director:** extract に sRGB hex 変換と多経路 CJK 検出を追加 ([#37](https://github.com/yukimasaki/claude-plugins/issues/37)) ([56c6df8](https://github.com/yukimasaki/claude-plugins/commit/56c6df847818deb4d2058a9c4393fc797b585ec2)), closes [#34](https://github.com/yukimasaki/claude-plugins/issues/34)

## [0.4.3](https://github.com/yukimasaki/claude-plugins/compare/v0.4.2...v0.4.3) (2026-04-28)


### Features

* **design-director:** /design-director extract &lt;url&gt; サブコマンドを追加 ([#32](https://github.com/yukimasaki/claude-plugins/issues/32)) ([bd93f69](https://github.com/yukimasaki/claude-plugins/commit/bd93f693cc16104652bf77d7cf8f292fd2ce20c9)), closes [#17](https://github.com/yukimasaki/claude-plugins/issues/17)

## [0.4.2](https://github.com/yukimasaki/claude-plugins/compare/v0.4.1...v0.4.2) (2026-04-28)


### Features

* **design-director:** 日本語サイト対応 — kzhrknt 25 サイト取り込み + CJK typography Layer ([#26](https://github.com/yukimasaki/claude-plugins/issues/26)) ([d942eea](https://github.com/yukimasaki/claude-plugins/commit/d942eeabbc4fb7427d408749306ee7b14622b4b3)), closes [#1](https://github.com/yukimasaki/claude-plugins/issues/1) [#1](https://github.com/yukimasaki/claude-plugins/issues/1)
