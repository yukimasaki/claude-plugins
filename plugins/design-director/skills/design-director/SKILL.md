...
`references/` 配下は open-codesign の prompts / design-skills / builtin-skills、getdesign.md（DESIGN.md 公式仕様）の design-md、rohitg00/awesome-claude-design の prompt-packs / recipes / family 体系の継承、本リポジトリ独自変換の design-md/ 16 サイトと recipes 3 件で構成される vendored 資産。
